...
//DATA GET AUDIENCE TO MESSAGES
function autoInicioAuditorio(){
    $.ajax({
        //url: "http://localhost:8080/api...",
...
function autoInicioMensajes(){
    ...
    $.ajax({
        //url: "http://localhost:8080/api...",
        url:"http://140.238.191.42:8080/api/Message/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
...
function guardarInformacionMensajes(){
    ...
    let var2 = {
        ...
        //url: "http://localhost:8080/api...",
        url:"http://140.238.191.42:8080/api/Message/save",
...
function actualizarInformacionMensaje(idElemento){
    ...
    $.ajax({
        //url: "http://localhost:8080/api...",
        url:"http://140.238.191.42:8080/api/Message/update",
        type:"PUT",
        data:dataToSend,
...
function borrarMensaje(idElemento){
    ...
    $.ajax({
        //url: "http://localhost:8080/api...",
        url:"http://140.238.191.42:8080/api/Message/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
