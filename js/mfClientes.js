...
function guardarInformacionCliente(){
    let var2 = {
        ...
        $.ajax({
            ...
            //url: "http://localhost:8080/api...",
            url:"http://140.238.191.42:8080/api/Client/save",
...
function actualizarInformacionCliente(idElemento){
    ...
    $.ajax({
        //url: "http://localhost:8080/api...",
        url:"http://140.238.191.42:8080/api/Client/update",
        type:"PUT",
        data:dataToSend,
...
function borrarCliente(idElemento){
    ...
    $.ajax({
        //url: "http://localhost:8080/api...",
        url:"http://140.238.191.42:8080/api/Client/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
